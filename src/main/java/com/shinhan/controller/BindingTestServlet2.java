	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charset=utf-8;");
 		response.getWriter().append("<h1>bind2</h1>Served at: ")
 				...
 				.append((String) request.getAttribute("mydata3")+"<br>")	//얻으면 무조건 obj임... 그러므로 String으로 형변환이 필요하다.
 				.append((String) request.getAttribute("myname"));	//얻으면 무조건 obj임... 그러므로 String으로 형변환이 필요하다.
	} 
}
